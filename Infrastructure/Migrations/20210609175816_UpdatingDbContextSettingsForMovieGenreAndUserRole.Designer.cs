...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20210609175816_UpdatingDbContextSettingsForMovieGenreAndUserRole")]
    partial class UpdatingDbContextSettingsForMovieGenreAndUserRole
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CrewMovieCrew", b =>
                {
                    ...
                    b.HasKey("CrewsId", "MovieCrewDepartment", "MovieCrewJob");

                    b.HasIndex("MovieCrewDepartment", "MovieCrewJob");

                    b.ToTable("CrewMovieCrew");
                });
            ...
            modelBuilder.Entity("CrewMovieCrew", b =>
                {
                    ...
                    b.HasOne("ApplicationCore.Entities.MovieCrew", null)
                        .WithMany()
                        .HasForeignKey("MovieCrewDepartment", "MovieCrewJob")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
